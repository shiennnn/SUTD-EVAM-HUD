...
double map_lat = 1.3423;
double map_lon = 103.959;
int map_zoom = 16;             // Instead of 16, download bigger tiles
...
void setup() {
  ...
  printf("\n=== Starting Setup ===\n");
  CANinit();
    // 1. Initialize I2C Wire FIRST before board
...
void ui_update() {
  ...
  if (millis() - lastArcUpdate > 50) {  //Only updates if 50ms has passed
